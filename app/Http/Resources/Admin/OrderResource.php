            ...
            'items' => $this->items->map(function ($item) {
                return [
                    ...
                    'design' => [
                        ...
                        'price' => (float) $item->design->price, // Current price
                        'is_active' => $item->design->is_active,
                        'primary_image' => $item->design->primary_image_url,
                        'user' => [
                            'id' => $item->design->user->id,
                            'name' => $item->design->user->name,
                        ],
                    ],
