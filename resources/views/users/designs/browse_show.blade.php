    ...
    <div class="row g-2 align-items-center">
        <div class="col">
            <div class="page-pretitle">
                <a href="{{ route('user.designs.browse') }}" class="text-muted">
                    <i class="ti ti-arrow-left"></i> {{ __('Back to Browse') }}
                </a>
            </div>
            <h2 class="page-title">
...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h3 class="card-title">{{ __('Designer') }}</h3>
                </div>
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <div class="text-muted">{{ __('Creator') }}</div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex">
                            ...
                            <div>
                                <div class="text-secondary">
                                    {{ __('This design was created by :name', ['name' => $design->user->name]) }}
                                </div>
                            </div>
                        </div>
                    </div>
